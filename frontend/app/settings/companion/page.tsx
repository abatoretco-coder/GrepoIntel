...
const errorLabels:Record<string,string>={pairing_required:"Pairing invalide",capture_timeout:"Capture impossible",runtime_capture_failed:"Capture impossible",import_failed:"Import impossible"};
