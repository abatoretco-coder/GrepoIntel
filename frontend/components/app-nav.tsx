...
import { Bell, Crosshair, LayoutDashboard, Map, ShieldAlert, Swords, Users, Settings, CalendarClock } from "lucide-react";

const items = [
  ["Dashboard", "/dashboard", LayoutDashboard], ["Carte tactique", "/map", Map], ["Joueurs", "/players", Users], ["Alliances", "/alliances", Users],
  ["Cibles", "/targets", Crosshair], ["Menaces", "/threats", ShieldAlert], ["Événements", "/events", Bell], ["Planificateur", "/planner", CalendarClock], ["Réglages", "/settings", Settings],
] as const;
